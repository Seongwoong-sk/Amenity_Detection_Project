# Open Image Dataset Classes 중에서 필요한 Classes만 추출해서 해당하는 이미지들을 저장하는 함수

import os
import pandas as pd
from shutil import copyfile
from absl import app # Tensorflow와 자주 사용되는 Terminal에서 Flag를 지정할 수 있는 absl
...
flags.DEFINE_string('class_file_path', 
                    default='C:/Users/rlatj/Desktop/Amenity/class-descriptions-boxable.csv',
                    help='class-descriptions-boxable.csv file path')
flags.DEFINE_string('annotation_file_path',
                    default='C:/Users/rlatj/Desktop/Amenity/validation-annotations-bbox.csv',
                    help='validation-annotations-bbox.csv file path')
flags.DEFINE_string('image_folder_path',
                    default='C:/Users/rlatj/Desktop/Amenity/open_images_validation',
                    help='image folder path')
flags.DEFINE_string('filtered_image_folder_path',
                    default='C:/Users/rlatj/Desktop/Amenity/filtered_validation_images', 
